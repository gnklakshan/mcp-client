...
CLAUDE_API_KEY = os.environ.get("CALAUDE_API_KEY","")
CLAUDE_API_URL ="https://api.anthropic.com/v1/message"
...
class ClaudeClient:
        ...
        self.tools = [
            {
                ...
                "desription":"Retrieves info from website based on user queries",
                "input_schema":{
                    "type":"object",
                    "properties":{
                        "query":{
                ...
                for content_block in result.get("content",[]):
                    if content_block.get("type")=="tool_use":
                        ...
                        conversation_history.append({
                            ...
                            "content": [{
                                "type":"text",
                                "text":result.get("content",[{}])[0].get("text","")+"\n\nThe tool call was successful and information from the tool call: " + tool_response["result"][0]["description"]
                            }]
                        })
                        return self.send_message("Please summarize the information from the tool call and don't send any more tool calls")
    ...
    def _handle_tool_call(self,tool_call:Dict[str,Any])->Dict[str,Any]:
        ...
        while retry_count < max_retries:
            try:
                response = requests.post(f"{MCP_SERVER_URL}/tool_call",
